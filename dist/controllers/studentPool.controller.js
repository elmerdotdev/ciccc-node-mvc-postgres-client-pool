...
const studentPool_model_1 = require("../models/studentPool.model");
// Get all students
const fetchAllStudents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const students = yield (0, studentPool_model_1.getAllStudents)();
...
const fetchStudentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const student = yield (0, studentPool_model_1.getStudentById)(id);
        if (student) {
...
const addStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newStudent = yield (0, studentPool_model_1.createStudent)(name, age, major);
...
const modifyStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(req.params.id, 10);
        const { name, age, major } = req.body;
        const updatedStudent = yield (0, studentPool_model_1.updateStudent)(id, name, age, major);
        if (updatedStudent) {
...
const removeStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(req.params.id, 10);
        const deletedStudent = yield (0, studentPool_model_1.deleteStudent)(id);
        if (deletedStudent) {
